...
public class HomeActivity extends TabActivity {
 ...
 // 	Intent i_search = new Intent(this, SearchActivity.class);
		...
		if(!(username.equals(""))){
			i_personal = new Intent(this, PersonalCenterActivity.class);		   
		}else{
		    i_personal = new Intent(this, PersonalActivity.class);
		}
...
//							break;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_exit:
			...
			showAlertDialog("退出程序", "确定退出乐购商城？", "确定", new OnClickListener() {
