...
public class PersonalActivity extends BaseActivity implements OnClickListener {
	...
	private RelativeLayout Ly_personalInfo,waitPay,allPay;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_nologin_personal);
		findViewById();
		initView();
	}
...
//		case R.id.waitpay:
//			mIntent = new Intent(PersonalActivity.this, OrderWaitPayrActivity.class);
//			startActivity(mIntent);
//			break;
//		
//		case R.id.allpay:
//			mIntent = new Intent(PersonalActivity.this,OrderAllPayrActivity.class);
//			startActivity(mIntent);
//			break;	
//
