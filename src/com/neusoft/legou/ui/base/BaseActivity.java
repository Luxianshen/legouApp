package com.neusoft.legou.ui.base;

import java.util.Locale;
import java.util.concurrent.Callable;

import com.neusoft.legou.AppManager;
import com.neusoft.legou.R;
import com.neusoft.legou.config.Constants;
import com.neusoft.legou.image.ImageLoaderConfig;
import com.neusoft.legou.task.AsyncCallable;
import com.neusoft.legou.task.Callback;
import com.neusoft.legou.task.EMobileTask;
import com.neusoft.legou.task.ProgressCallable;
...
//獲得設備信息
 ...
 protected String getCountry() {
	...
	protected <T> void doAsync(final int pTitleResID, final int pMessageResID, final Callable<T> pCallable, final Callback<T> pCallback, final Callback<Exception> pExceptionCallback) {
		com.neusoft.legou.task.EMobileTask.doAsync(this, pTitleResID, pMessageResID, pCallable, pCallback, pExceptionCallback);
	}
